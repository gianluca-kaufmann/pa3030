...
\citep{diaz2019, mouillot2024}, %TODO: These sources do not support the claim. Look for better sources.
including the Amazon rainforest, the Cerrado savanna, the Andean
...
rasterisation used here, generating
sufficient temporal variation in designations to train a transition model. %TODO: Must be supported by sources, or our own data.
Third, the
...
range of drivers. %TODO: Assess whether these sources are enough to support this claim. Just checking.

The study covers all sovereign terrestrial land areas of South America at a $1 \times 1$~km %TODO: The 1x1 km resolution choice must be justified and supported by litertaure, either here or in methods, wherever it fits better. New literature specific to the choice of resolution must be found and cited.
...
high data quality, and a current PA coverage of approximately 7.7\%. %TODO: Must be supported by sources, or our own data, or reworded.
 The US is not a
...
making the intensity of future designation pressure more uncertain than in South America. %TODO: Is this still true? Might have changed under the new administration.
...
that stresses the model's calibration and rare-event detection capabilities. %TODO: Must be supported by sources, or our own data, or reworded.
...
South America's \citep{dinerstein2020}, %TODO: This source does not support the claim. Look for better sources.
making it a natural candidate to test whether predictive
...
out-of-sample environment. %TODO: Must be supported by sources, or our own data, or reworded. Too long sentence as well
...
legal designation in some jurisdictions \citep{bingham2019}.
...
data-quality implications are discussed in Section~\ref{sec:discussion_limitations}. %TODO: This paragraph is relevant, but we should probably move it to the limitations section.
...
a biogeographic stratification. %TODO: Do we have to add the citations from the table above here again? Or no?
...
value is carried forward within each cell. %TODO: MAybe we should support our forward filling method with a citation.
...
decisions operate. Web Mercator introduces latitude-dependent areal distortion that increases away from
...
indicating that, in this model, stronger rule of law is positively associated with
designation probability across South America. The V-Dem Liberal Democracy Index
...
(0.614) and SEA$\to$SA (0.598). This suggests that RF's bagged architecture captures
more transferable ecological baselines while LGBM is more sensitive to region-specific
institutional patterns. LGBM-based transition-risk scores therefore require
region-specific models; whether RF-based scores could support global risk assessment
with a shared feature set is a direction for future work.
...
of observations positive), indicating that rule of law is positively associated with
designation probability across much of the continent in this model. In
...
available low-cost land, leaving some biodiversity-rich contexts underrepresented.
That interpretation is consistent with literature showing that PA expansion often
favours easier-to-protect land \citep{venter2018}; it also underscores why meeting
30$\times$30 biodiversity goals requires active national coordination
\citep{eckert2023}.
...
five-year lookahead window reduces sensitivity to small date
...
origin, the LightGBM backtest model is trained on 2001--$(T-5)$, scores year-$T$
...
\begin{table}[H]
  \centering
  \small
  \caption{LightGBM walk-forward backtest metrics by origin year. $N$ pos.\ denotes
  ...
  \begin{tabular}{llrrr}
    ...
    \midrule
    South America & 2013 & 217,489 & 0.1111 & 0.0482 \\
    South America & 2015 & 205,855 & 0.0477 & 0.0231 \\
    South America & 2017 & 189,449 & 0.0199 & 0.0125 \\
    South America & 2019 & 59,245  & 0.0085 & 0.0049 \\
    United States & 2013 & 17,624  & 0.0043 & 0.0015 \\
    United States & 2015 & 9,762   & 0.0017 & 0.0007 \\
    United States & 2017 & 7,306   & 0.0002 & 0.0004 \\
    United States & 2019 & 333     & 0.0001 & 0.0001 \\
    Southeast Asia & 2013 & 76,476 & 0.0302 & 0.0209 \\
    Southeast Asia & 2015 & 80,569 & 0.0360 & 0.0211 \\
    Southeast Asia & 2017 & 37,778 & 0.0140 & 0.0233 \\
    Southeast Asia & 2019 & 12,414 & 0.0269 & 0.0130 \\
    \bottomrule
  \end{tabular}
\end{table}

South America shows declining absolute precision across later origin years, from
0.1111 at $T=2013$ to 0.0085 at $T=2019$, while the United States remains very low
in absolute terms throughout. Southeast Asia is more stable, with Precision@1\%
between 0.0140 and 0.0360 across the four saved backtests.
