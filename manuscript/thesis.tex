...
\begin{figure}[H]
  ...
  \caption{South America: cumulative protected-area coverage (2000--2024). Each data
  point is the share of the total land surface classified as protected in the
  corresponding WDPA annual raster. The dashed red line marks the Kunming-Montreal
  30\% target. Coverage grew rapidly during 2000--2013 (Amazon and Cerrado expansion
  programmes) and has since plateaued well below the 30$\times$30 threshold.}
...
available at global scale. Land tenure, specifically whether a parcel is federally owned versus
...
positive examples, including Tropical and Subtropical Moist Broadleaf Forests (0.826), Tropical
Dry Broadleaf Forests (0.818), Temperate Conifer Forests (0.822), Mangroves (0.957),
and Tropical Coniferous Forests (0.991), all exceed ROC-AUC 0.8. This consistency
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.48\textwidth}
    ...
    \caption{Biodiversity priority alignment. Green: GSN biodiversity priority area;
    orange: projected 30$\times$30 designations; yellow: sweet-spot overlap
    (145,154~km$^2$).}
  ...
  \begin{subfigure}[t]{0.48\textwidth}
    ...
    \caption{Climate-stabilisation priority alignment. Green: GSN climate-stabilisation
    priority area; orange: projected 30$\times$30 designations; yellow: sweet-spot
    overlap (8,539~km$^2$).}
    \label{fig:alignment_climate}
  \end{subfigure}
  \caption{Overlap between projected 30$\times$30 scenario designations and GSN
  ecological priority areas in South America (LightGBM forward model). Only 18.4\%
  of projected biodiversity-priority km$^2$ overlap with the designation frontier;
  climate-stabilisation priority overlap is even lower at 1.1\%. The mismatch
  illustrates the representation gap: path-of-least-resistance expansion does not
  target the most ecologically critical land.}
  \label{fig:alignment}
\end{figure}
...
This appendix consolidates the per-biome Leave-One-Biome-Out (LOBO) ROC-AUC tables
