...
\citep{diaz2019}.
The IPBES Global Assessment reports that human activities have already
substantially altered three-quarters of the Earth's land surface and that as many as
one million plant and animal species face extinction; interlinked
drivers---land-use change, overexploitation, climate change, invasive species, and
pollution---compound ecological pressure and erode the capacity of ecosystems to sustain
human well-being \citep{brondizio2019ipbes}.
...
for avoided deforestation and other carbon-finance mechanisms create additional
incentives to protect high-carbon forests. Carbon revenues can materially narrow the
...
scale. Their results show that protected areas, particularly the most restrictive
ones, are highly unevenly distributed and often over-aggregate where human
development and the number of non-governmental organisations are high, leaving many
...
effective area-based conservation measures (OECMs) \citep{fitzsimons2025}. Dasgupta et al.\
(\citeyear{dasgupta2025}) use country case studies to identify new opportunities for
...
production cutbacks and workforce contraction, with exploratory evidence of lower
...
Within that transition-risk framing \citep{govind2025, tnfd2023}, a calibrated designation probability
...
designation probabilities become widely available.
