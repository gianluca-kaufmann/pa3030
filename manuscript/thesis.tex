...
infrastructure development \citep{schuster2023}, generating material \emph{transition
...
assets sit in locations most likely to be designated \citep{robinson2024}. Financial
supervisors and central banks have increasingly identified nature-related land-use
transitions as sources of systemic financial exposure \citep{govind2025}, and
nature-related disclosure frameworks explicitly identify PA creation as a transition
risk category affecting business operations and land-secured lending. A spatially
explicit PA probability model directly addresses these needs: knowing \emph{where}
designation pressure is concentrated allows banks and asset managers to quantify
transition risk in their portfolios and communicate material exposures to regulators.

Historical PA designation is not spatially random: governments systematically
protect land that is remote, ecologically important, and cheap to designate,
characterised by high elevation, steep slopes, low population density, and
...
used to build a forward-looking transition-risk model. Recent work confirms this principle \citep{mouillot2024, greenhill2024}, but no prior
study combines a temporal panel structure, multi-region comparison, probability
calibration, and forward deployment into a coherent transition-risk tool; existing
approaches are retrospective, single-region, or lack calibrated probability outputs.
