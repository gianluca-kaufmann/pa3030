...
def compute_shap_analysis(
    ...
    SHAP_FEATURE_RENAME = {
        ...
        "GSN_b4":                  "Wildlife Corridor",
        "GSN_b4_smooth16":         "Wildlife Corridor (16 km)",
        "GSN_b4_smooth64":         "Wildlife Corridor (64 km)",
        "policy_b4":               "Rule of Law (WGI)",
        "policy_b2":               "Liberal Democracy (V-Dem)",
        "policy_b3":               "Govt Effectiveness (WGI)",
        "WorldClim_b4":            "Temp. Seasonality",
        "WorldClim_b7":            "Temp. Annual Range",
        "WorldClim_b8":            "Temp. Wettest Quarter",
        "WorldClim_b11":           "Temp. Coldest Quarter",
