...
LAG_COLS = [
    ...
    "pa_cumsum_lag1_pixels",   # running total of designated pixels — frontier saturation
]
POLITICAL_COLS = [
    "v2x_polyarchy",
    "v2x_corr",
    ...
    "gov_wgi_rl_est",
    "gdp_per_capita",
    "gdp_growth_lag1",         # year-on-year GDP/capita growth, lagged 1yr (from WDI)
...
def main() -> None:
    ...
    print(f"Stage 1 Poisson GLM — South America")
