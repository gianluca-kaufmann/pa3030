#!/usr/bin/env python3
"""Stage: SE Asia pathway analysis — coverage trajectories and milestone tables.
...
Note: SE Asia has WDPA rasters for 2000 and 2019 in addition to 2024, giving
a richer historical series than SA or USA.
...
if __name__ == "__main__":
    ...
    run_region_forward("se_asia", stage="pathway", model_type=model_type)
