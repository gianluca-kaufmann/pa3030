#!/usr/bin/env python3
"""Build country-year panel for Stage 1 expansion model (SE Asia).
...
Output:
    data/se_asia/stage1_panel.parquet
"""
...
REGION = "se_asia"
OUT_PATH = _ROOT / "data" / "se_asia" / "stage1_panel.parquet"
...
def attach_political_covariates(cy: pd.DataFrame) -> pd.DataFrame:
    ...
    # v2csprtcpt). Partial load avoids silently dropping v2x_polyarchy.
...
def main() -> None:
    ...
    meta_path = _ROOT / "outputs" / "data_checks" / "stage1_panel_se_asia_build.json"
